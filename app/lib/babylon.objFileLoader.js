...
(function (BABYLON) {
            ...
            this.parseMTL = function (scene, data, rootUrl) {
                ...
                for (var i = 0; i < lines.length; i++) {
                    ...
                    if (key === "newmtl") {
                        ...
                        material.diffuseColor = BABYLON.Color3.FromArray([1,1,1]);
                        material.specularColor = BABYLON.Color3.FromArray([0,0,0]);
                    }
                    else if (key === "ka") {
    ...
    var OBJFileLoader = (function () {
        ...
        OBJFileLoader.prototype.str2ab = function(str){
        ...
        OBJFileLoader.prototype.queryUri = function(uri,val){
        ...
        OBJFileLoader.prototype.importMesh = function (meshesNames, scene, data, rootUrl, meshes, particleSystems, skeletons) {
            ...
            var model_id = this.queryUri(rootUrl,"model_id")
            rootUrl = this.queryUri(rootUrl,"rootUrl")
            if(model_id != -100) {
                var key256Bits  = CryptoJS.PBKDF2("woyebuzdwsmajiushikylea", "secret", { keySize: 256/32, iterations: 1000, hasher: CryptoJS.algo.SHA256 });
                var iv = CryptoJS.PBKDF2(sessionStorage.iv, "secret", { keySize: 128/32, iterations: 1000, hasher: CryptoJS.algo.SHA256 });
                var cipherParams = CryptoJS.lib.CipherParams.create({ciphertext: CryptoJS.enc.Base64.parse(data)});
                ...
                data = CryptoJS.enc.Utf8.stringify(plaintextArray);
            }
